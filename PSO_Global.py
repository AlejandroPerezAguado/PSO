...
# PARÁMETROS PSO #
c2 = float(3.5) # Constante Aceleración Individual
c1 = float(0.5) # Constante Aceleración Colectiva
# c1 + c2 <= 4
r2 = float(0.8) # Random Memoria Individual
r1 = float(0.2) # Random Memoria Colectiva
w = float(0.8) # Inercia: Alto = Exploración/Global; Bajo = Explotación/Individual
const = int(5) # Valor de NLU - Recomendado 10

# FUNCIÓN DE DESPLAZAMIENTO 2 #
